...
/* themes/custom/longinus/templates/navigation/links--language-block.html.twig */
class __TwigTemplate_c36e859226a2e099e1c20d29a4c1a6f9ec37391c8fed310f0180b347a34245b8 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["links"] ?? null)) {
            ...
            if (($context["heading"] ?? null)) {
                ...
                if (twig_get_attribute($this->env, $this->source, ($context["heading"] ?? null), "level", [], "any", false, false, true, 36)) {
                    ...
                    // line 39
                    echo "<div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["heading"] ?? null), "attributes", [], "any", false, false, true, 39), "addClass", [0 => "block-languagemenu__title"], "method", false, false, true, 39), 39, $this->source), "html", null, true);
                    echo ">";
            ...
            // line 42
            echo "<ul";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "block-languagemenu__items"], "method", false, false, true, 42), 42, $this->source), "html", null, true);
            echo ">";
            // line 43
...
$context["item"], "text_attributes", [], "any", false, false, true, 47)) {
                    // line 48
                    echo "<span";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "text_attributes", [], "any", false, false, true, 48), "addClass", [0 => "block-languagemenu__link"], "method", false, false, true, 48), 48, $this->source), "html", null, true);
                    echo ">";
    ...
    {
        return "themes/custom/longinus/templates/navigation/links--language-block.html.twig";
    }
...
{% if links -%}
  {%- if heading -%}
    ...
    {%- else -%}
      <div{{ heading.attributes.addClass('block-languagemenu__title') }}>{{ heading.text }}</div>
    {%- endif -%}
  {%- endif -%}
  <ul{{ attributes.addClass('block-languagemenu__items') }}>
    {%- for item in links -%}
      <li{{ item.attributes.addClass('block-languagemenu__item') }}>
        {%- if item.link -%}
          {{ item.link }}
        {%- elseif item.text_attributes -%}
          <span{{ item.text_attributes.addClass('block-languagemenu__link') }}>{{ item.text }}</span>
        {%- else -%}
          {{ item.text }}
        {%- endif -%}
      </li>
...
{%- endif %}
", "themes/custom/longinus/templates/navigation/links--language-block.html.twig", "/var/www/html/web/themes/custom/longinus/templates/navigation/links--language-block.html.twig");
    }
