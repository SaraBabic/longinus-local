...
class __TwigTemplate_87fcb7c27d02dabae035fbf8cbfb69e7a14c14a898def209c5ebc1201fd23ade extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
      ...
      <div";
        ...
        if (($context["display_submitted"] ?? null)) {
            // line 26
            echo "              <footer class=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["longinus_block"] ?? null), 26, $this->source), "html", null, true);
            echo "__meta\">
                  <div";
            // line 27
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", [0 => ($this->sandbox->ensureToStringAllowed(($context["longinus_block"] ?? null), 27, $this->source) . "__submitted")], "method", false, false, true, 27), 27, $this->source), "html", null, true);
            echo ">
                      ";
            // line 28
        ...
        // line 33
        echo "          ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 33, $this->source), "links"), "html", null, true);
        echo "
      </div>

        ";
        // line 36
        if (twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "links", [], "any", false, false, true, 36)) {
            // line 37
            echo "          <div class=\"";
            ...
            echo "__links\">
              ";
            // line 38
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "links", [], "any", false, false, true, 38), 38, $this->source), "html", null, true);
            echo "
          </div>
        ";
        }
    ...
    {
        return array (  143 => 41,  137 => 38,  132 => 37,  130 => 36,  123 => 33,  116 => 29,  112 => 28,  108 => 27,  103 => 26,  101 => 25,  97 => 24,  91 => 22,  81 => 19,  76 => 18,  74 => 17,  69 => 16,  65 => 15,  60 => 42,  58 => 15,  52 => 14,  49 => 13,  47 => 10,  46 => 9,  45 => 8,  44 => 7,  43 => 6,  42 => 5,  40 => 2,);
    }
    ...
    {% block content %}
      ...
      <div{{ content_attributes.addClass(longinus_block ~ '__content') }}>
          {% if display_submitted %}
              <footer class=\"{{ longinus_block }}__meta\">
                  <div{{ author_attributes.addClass(longinus_block ~ '__submitted') }}>
                      {{ date }}
                      {{ metadata }}
                  </div>
              </footer>
...
", "themes/custom/longinus/templates/content/node.html.twig", "/var/www/html/web/themes/custom/longinus/templates/content/node.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 2, "escape" => 14, "without" => 33);
