...
(function ($, Drupal) {
    ...
    $(".block-languagemenu__items").on("click", function () {
        $(".block-languagemenu__items").toggleClass("opened");
      });
    ...
    $(".block-mainnavigation-2__menu-item--expanded").click(function(){
        if($(".block-mainnavigation-2__submenu").hasClass('opened-submenu')) {
            $(".block-mainnavigation-2__submenu").removeClass('opened-submenu');
        }
        else {
            $(".block-mainnavigation-2__submenu").addClass("opened-submenu");
        }
      });
