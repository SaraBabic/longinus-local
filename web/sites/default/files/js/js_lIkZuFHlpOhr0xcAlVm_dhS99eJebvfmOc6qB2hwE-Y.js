...
(function ($, Drupal) {
    // Language switcher selected set active.
      $(".block-languagemenu__items").click(function(){
        console.log('click');
        if($(".block-languagemenu__items").hasClass('opened')) {
            $(".block-languagemenu__items").removeClass('opened');
        }
        else {
            $(".block-languagemenu__items").addClass("opened");
        }
      });
    ...
    $(".block-mainnavigation-2__menu li:nth-child(3)").click(function(){
        if($(".block-mainnavigation-2__menu li:nth-child(3)>.block-mainnavigation-2__submenu").hasClass('opened-submenu')) {
            $(".block-mainnavigation-2__menu li:nth-child(3)>.block-mainnavigation-2__submenu").removeClass('opened-submenu');
        }
        else {
            $(".block-mainnavigation-2__menu li:nth-child(3)>.block-mainnavigation-2__submenu").addClass("opened-submenu");
        }
      });
